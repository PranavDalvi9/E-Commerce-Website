    ...
    <div>
      ...
      <div>
        ...
        >
          ...
          <Button className='ButtonDiv' variant="contained" onClick={() => handleAdd()} >Login</Button><br />

          <Button className='ButtonDiv' variant="contained" onClick={() => { navigate("/register") }} >Register</Button><br />
