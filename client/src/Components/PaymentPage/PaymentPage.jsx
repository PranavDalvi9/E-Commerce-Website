...
export default function PaymentPage() {
  ...
  const initPayment = (data) => {
    const options = {
      ...
      handler: async (response) => {
        try {
          const verifyUrl = "https://e-commerce-website-pranav.herokuapp.com/api/payment/verify";
  ...
  const handlePayment = async () => {
    try {
      const orderUrl = "https://e-commerce-website-pranav.herokuapp.com/api/payment/orders";
