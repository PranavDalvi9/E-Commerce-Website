...
export default function TrendingProducts() {
    ...
    useEffect(() => {
        axios.get("https://e-commerce-website-pranav.herokuapp.com/product").then((res) => setData(res.data));
        ...
        <div className='TrendingProducts'>
            <div className='TrendingProductsHeading'>
                ...
                <div className='TrendingProductsCategory'>
                    <div onClick={() => navigate("/category/men-jeans/products")}><p>Men</p></div>
                    <div onClick={() => navigate("category/women-kurtas-suits/products")}><p>Women</p></div>
                    <div onClick={() => navigate("/category/baby-wears/products")}><p>Baby</p></div>
                </div>
            </div>
