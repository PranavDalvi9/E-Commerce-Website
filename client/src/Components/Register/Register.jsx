    ...
    <div>
      ...
      <div>
        ...
        >
          ...
          <Button className='ButtonDiv' variant="contained" onClick={() => handleRegister()} >Register</Button><br />

          <Button className='ButtonDiv' variant="contained" onClick={() => { navigate("/login") }}>Login</Button><br />

          <Button className='ButtonDiv' variant="contained" onClick={() =>
            window.open("https://e-commerce-website-pranav.herokuapp.com/auth/google", "_self")
