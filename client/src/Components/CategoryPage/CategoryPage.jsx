        ...
        <div className='FilterDiv'>
          <FormControl >
            ...
            <RadioGroup className='checkDiv'
              ...
              name="radio-buttons-group"
            >
              <FormControlLabel value="28" onClick={() => { SetSize("28") }} control={<Radio />} label="28" />
              <FormControlLabel value="32" onClick={() => { SetSize("32") }} control={<Radio />} label="32" />
              <FormControlLabel value="34" onClick={() => { SetSize("34") }} control={<Radio />} label="34" />
              <FormControlLabel value="36" onClick={() => { SetSize("36") }} control={<Radio />} label="36" />
            </RadioGroup>
